...
namespace BusinessLogic
{
    public class AuditManagement
    {
        ...
        //{
        //    var param = _user.GetDetailsByUsername(request.UserName);
        //    if (param != null)
        //    {
        ...
        //        InsertAudit(request.UserName, Constants.ActionType.LogoutAccount.ToString(), "Logout", DateTime.Now, request.Computername, request.SystemIp);
        //        return new UserDetailsResponse
        //        {
        //            ResponseCode = "00",
        //            ResponseMessage = "Lock successful",
        //             UserDetails = result
        ...
        //    else
        //    {
        //        Log.InfoFormat(request.Computername, request.SystemIp, request.UserName, Constants.ActionType.LogoutAccount.ToString());
        //        return new UserDetailsResponse
        //        {
        //            ResponseCode = "01",
        //            ResponseMessage = "Logout failed"
